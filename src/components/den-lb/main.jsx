            ...
            await getDocuments('users-lb')
                .then((d) => {
                    d.docs.forEach(element => {
                        ...
                        index['userRef'] = doc(db, 'users-lb', element.id);
                        apiUsers.push(index);
                    });
                    setUsers(apiUsers);
                })
